...
path='/expanse/lustre/scratch/ssonti/temp_project/amber_learn/chignolin_tutorial/westpa_tutorials/tutorial7.3-chignolin/ParGaMD'
os.chdir(path)
...
for i in range(iters):
    ...
    for j in range(iter_iters[i]):
        ...
        try:
            ...
            fes_all.append(np.delete(fes,np.s_[:5],axis=0))
