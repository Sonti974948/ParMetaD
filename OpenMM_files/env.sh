...
module load cuda/11.2.2/blza2ps
#module load amber/20
module load plumed/2.6.3/fxev5vk
#module load conda
...
export PLUMED_KERNEL=/cm/shared/apps/spack/0.17.3/gpu/b/opt/spack/linux-rocky8-cascadelake/gcc-10.2.0/plumed-2.6.3-fxev5vkpq6j44fdvkioucgvwonjadjbt/lib/libplumedKernel.so
...
export NODELOC=/expanse/lustre/scratch/ssonti/temp_project/amber_learn/chignolin_tutorial/westpa_tutorials/tutorial7.3-chignolin/ParMetaD_openmm/ParMetaD/AMBER_files
